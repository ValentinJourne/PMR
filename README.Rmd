...
Parameters are in the following order, for example if it is a unimodal submodel (here example with Abies parameters) : $t$; $t0$; $F_crit$; $T50$; $dT$; $C_crit$; $a$; $b$; $c$. The last parameters are parameters for the sigmoid function of rate of chilling.
